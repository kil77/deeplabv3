...
def main():
    ...
    ih, iw = tf.shape(image_batch_val)[1], tf.shape(image_batch_val)[2]
    image_batch_val, label_batch_val = tf.cond(tf.greater(ih,1920),lambda :(resize_img_and_label(image_batch_val,label_batch_val,1280,720)),lambda :(image_batch_val, label_batch_val ))
